...
const LOCALES = {
  ...
  es: {
    ...
    "tab.quickCost": "Costeo Rápido",
    "tab.batch": "Lote",
    "tab.monthly": "Mensual",
    "tab.saved": "Guardados",
    "sc.emptyHint": "Guarda un costeo desde Costeo Rápido o Lote para verlo aquí.",
    "sc.openAt": "Se abre en",
    "sc.unit": "unidad",
    "header.tryDemo": "Probar demo",
    "quick.headerTitle": "Tus gastos",
    "quick.headerSubtitle": "Solo ingresa qué usaste y qué compraste. Nosotros hacemos los cálculos.",
    "quick.modeSimple": "Simple",
    "quick.modeAdvanced": "Avanzado",
    "quick.modeSimpleHint": "Solo materiales, mano de obra y precio.",
    "quick.modeAdvancedHint": "Desglose completo — alquiler, electricidad, máquinas, escala.",
    "quick.productName": "Nombre del producto",
    "quick.productNamePlaceholder": "ej. Camiseta de algodón",
    "quick.unitsProduced": "Unidades producidas",
    "materials.title": "¿Qué materias primas usaste?",
    "materials.hint": "tela, harina, aceite — lo que hayas usado",
    "materials.addLabel": "Agregar material",
    "materials.empty": "Aún no hay materiales agregados.",
    "materials.columnName": "Material",
    "materials.columnQty": "Cant. consumida",
    "materials.columnUnit": "Unidad",
    "materials.columnPurchased": "Comprado",
    "materials.columnCost": "Costo",
    "materials.columnAuto": "Automático",
    "mat.sourceLocal": "Local",
    "mat.sourceImported": "Importado",
    "mat.delivery": "Entrega",
    "mat.materialPrice": "Precio del material",
    "mat.freight": "Flete",
    "mat.duty": "Arancel",
    "mat.taxes": "Impuestos",
    "mat.taxAmount": "Monto del impuesto",
    "mat.taxRecoverable": "El impuesto se puede recuperar",
    "mat.taxRecoverableYes": "Sí — excluido",
    "mat.taxRecoverableNo": "No — incluido en el costo",
    "mat.recoverableTaxNote": "No incluido en el costo del producto",
    "mat.taxInLandedCost": "Impuesto incluido en el costo del producto",
    "mat.taxColNonRecov": "Impuesto (no recuperable)",
    "mat.taxColRecov": "Impuesto (recuperable — excluido)",
    "mat.clearing": "Despacho / Otros",
    "mat.landedCost": "Costo total puesto en planta",
    "mat.localHelper": "El costo local incluye la compra y la entrega.",
    "mat.importedHelper": "El costo importado incluye flete, aranceles, impuestos y despacho.",
    "mat.warningImportedBlank": "Seleccionaste importado pero aún no ingresaste costos de importación.",
    "mat.warningZeroLanded": "El costo puesto en planta es cero — ingresa primero el precio del material.",
    "labor.title": "¿Quién trabajó en esta producción?",
    "labor.hint": "horas usadas vs. horas mensuales totales",
    "labor.addLabel": "Agregar persona",
    "labor.empty": "Agrega la mano de obra de esta producción.",
    "labor.columnRole": "Puesto",
    ...
    "electricity.hint": "parte de la factura",
    "electricity.unitsUsed": "Unidades usadas",
    "electricity.billUnits": "Unidades totales de la factura",
    "electricity.billAmount": "Importe de la factura",
    "electricity.warningUnitsExceed": "Las unidades usadas superan el total de la factura.",
    "rent.title": "¿Cuánto alquiler corresponde a la producción?",
    "rent.hint": "solo la parte de la fábrica",
    "rent.tooltip": "El alquiler de oficina y administración normalmente no debería afectar el costo de fabricación.",
    "rent.monthlyRent": "Alquiler mensual",
    "rent.factoryPct": "% Fábrica",
    "rent.warehousePct": "% Almacén",
    "rent.officePct": "% Oficina",
    "rent.daysUsed": "Días usados",
    "rent.daysInMonth": "Días del mes",
    "rent.includeWarehouse": "Incluir almacén",
    "rent.warningPct": "Los porcentajes no suman 100%",
    "packaging.title": "¿Qué embalaje se usó?",
    "packaging.hint": "cajas, bolsas, etiquetas",
    "packaging.addLabel": "Agregar embalaje",
    "packaging.empty": "Agrega embalaje si corresponde.",
    "other.title": "¿Algún otro gasto?",
    "other.hint": "transporte, reparaciones, lo que sea",
    "other.addLabel": "Agregar gasto",
    "other.columnItem": "Concepto",
    "other.columnCost": "Costo",
    "machines.title": "¿Incluir desgaste de máquinas?",
    "machines.hint": "opcional",
    "machines.description": "Opcional: incluye el costo de desgaste de máquinas en el costeo del producto.",
    "machines.on": "Activado",
    "machines.off": "Desactivado",
    "machines.methodTime": "Por tiempo",
    "machines.methodProduction": "Por producción",
    "machines.columnMachine": "Máquina",
    "machines.columnCost": "Costo",
    "machines.columnLife": "Vida útil (años)",
    "machines.columnDaysUsed": "Días usados",
    "machines.columnDaysYear": "Días / año",
    "machines.columnCapacity": "Capacidad total",
    "machines.columnBatch": "Unidades del lote",
    "machines.columnAllocated": "Asignado",
    "machines.explainerTime": "Depreciación anual = costo ÷ vida útil. Luego se prorratea por días usados.",
    "machines.explainerProduction": "Costo por unidad = costo de la máquina ÷ capacidad total. Multiplicado por unidades producidas.",
    ...
    "pricing.marginField": "Margen deseado (beneficio como % del precio)",
    "pricing.markupField": "Recargo deseado (beneficio como % del costo)",
    "pricing.targetField": "Beneficio objetivo por unidad",
    "pricing.marginHint": "Margen: beneficio como parte del precio de venta. 30% de margen = 30 de beneficio en una venta de 100.",
    "pricing.markupHint": "Recargo: beneficio como parte del costo. 40% de recargo sobre un costo de 100 = precio de venta de 140.",
    "pricing.targetHint": "Fija un beneficio por unidad. Precio = costo por unidad + tu objetivo.",
    "whatif.title": "¿Qué pasa si produces más?",
    "whatif.hint": "mira cómo baja el costo por unidad con la escala",
    "whatif.empty": "Ingresa primero tus costos y unidades para simular una producción mayor.",
    "whatif.intro": "Los costos fijos (alquiler, electricidad, mano de obra, máquinas) no cambian. Los costos variables (materiales, embalaje) escalan con la producción.",
    "whatif.columnProduction": "Producción",
    "whatif.columnCostPerUnit": "Costo / unidad",
    "whatif.columnSellAt": "Vender a",
    "whatif.columnProfit": "Beneficio",
    "whatif.columnMargin": "Margen",
    "whatif.now": "Ahora",
    "whatif.if": "Si",
    "whatif.unitsLabel": "unidades",
    "whatif.addScenario": "Agregar escenario",
    "whatif.whyTitle": "Por qué importa:",
    "whatif.whyBody": "Tus costos fijos de {amount} se reparten entre cada unidad que fabricas. Producir más unidades hace que cada una absorba una parte menor — eso es la economía de escala.",
    "summary.live": "Resumen en vivo",
    "summary.suggestedPrice": "Precio de venta sugerido",
    "summary.perUnit": "por unidad",
    "summary.margin": "margen",
    "summary.costPerUnit": "Costo / unidad",
    "summary.profitPerUnit": "Beneficio / unidad",
    "summary.totalProfit": "Beneficio total",
    "summary.totalCost": "Costo total",
    "summary.costBreakdown": "Desglose de costos",
    "summary.groupCosts": "Costos",
    "summary.groupDirect": "Costos directos",
    "summary.groupIndirect": "Costos indirectos",
    "summary.groupOptional": "Opcional",
    "summary.insights": "Análisis",
    "summary.savedSnapshots": "Instantáneas guardadas",
    "summary.sellAt": "Vender a",
    "summary.enterData": "Ingresar datos",
    ...
    "warning.usedExceedsPurchased": "La cantidad usada supera la cantidad comprada.",
    "warning.unitMismatch": "unidades no coinciden",
    "warning.rowsHaveWarnings": "Algunas filas tienen advertencias",
    "insight.lossSelling": "Estás vendiendo por debajo del costo — cada unidad pierde dinero.",
    "insight.marginLow": "El margen es {margin}% — por debajo del rango recomendado para fabricación.",
    "insight.marginHealthy": "Un margen de {margin}% es sólido — buen colchón para descuentos e imprevistos.",
    "insight.biggestLever": "El costo de {name} es {pct}% del total — tu mayor palanca.",
    "insight.largestCost": "{name} es el mayor costo con {pct}%.",
    "insight.laborHigh": "El costo de mano de obra es inusualmente alto — revisa las horas usadas vs. la capacidad mensual.",
    "insight.electricityMinimal": "El impacto de la electricidad es mínimo aquí.",
    "insight.packagingHigh": "El embalaje está reduciendo el beneficio. Considera compra al por mayor o alternativas.",
    "ui.quickAdd": "Agregar rápido",
    "ui.selectCurrency": "Seleccionar moneda",
    "ui.selectLanguage": "Idioma",
    "ui.searchCurrency": "Buscar moneda o código…",
    "ui.noCurrencyMatch": "Ninguna moneda coincide",
    "ui.enterUnitsHint": "Ingresa las unidades producidas para calcular",
    "currency.warnTitle": "Moneda no convertida",
    "currency.warnBody": "Cambiar de moneda solo cambia el símbolo — los importes existentes NO se convierten. Tus cifras se tratarán como la nueva moneda.",
    "currency.warnSwitch": "Cambiar de todos modos",
    "currency.warnCancel": "Mantener actual",
    "row.incomplete": "Incompleto · no contado",
    "mat.purchaseCostTotal": "Costo total de compra",
    "mat.consumed": "Consumido",
    "mat.purchaseCost": "Costo de compra",
    "mat.autoCost": "Costo automático",
    "mobile.sellAt": "Vender a",
    "report.brand": "Costix · Informe de costeo de producto",
    "report.titleCosting": "Resumen de costeo",
    ...
    "report.titleWhatIf": "Análisis de producción a escala",
    "report.metric": "Métrica",
    "report.value": "Valor",
    "report.category": "Categoría",
    "report.group": "Grupo",
    "report.amount": "Importe",
    "report.shareOfTotal": "Porcentaje del total",
    "report.totalCost": "Costo total",
    "report.totalMaterials": "Total materiales",
    "report.totalLabor": "Total mano de obra",
    "report.totalMachineCost": "Costo total de máquinas",
    "report.note": "Nota: Los costos fijos de {amount} se reparten entre cada unidad producida.",
    "report.scaleNote": "A medida que aumenta el volumen de producción, cada unidad absorbe una parte menor del costo fijo.",
    "report.footer": "Generado por Costix",
    "landing.heroTitle": "Conoce tu costo real.",
    "landing.heroSubtitle": "Más inteligente que las hojas de cálculo. Más simple que un ERP. Dinos qué compraste y usaste — Costix hace el resto.",
    "landing.cta": "Empezar a calcular",
    "landing.badge": "Costeo moderno para la fabricación moderna",
    "landing.heroTitleA": "Conoce tu costo real.",
    ...
    "batch.q3LabelRate": "Tarifa / hora",
    "batch.q4Title": "¿Algún gasto adicional?",
    "batch.q4Hint": "Embalaje, electricidad, transporte.",
    "batch.q4LabelExtra": "Gastos adicionales",
    "batch.q4LabelMargin": "Margen de beneficio",
    ...
    "batchwiz.step1Title": "Cuéntanos sobre esta producción",
    "batchwiz.step1Hint": "Solo lo básico — nombre y cuántas hiciste.",
    "batchwiz.step2Title": "¿Qué materias primas usaste?",
    "batchwiz.step2Hint": "Agrega lo que consumiste. Nosotros calculamos el costo.",
    "batchwiz.step3Title": "¿Quién trabajó en esta producción?",
    "batchwiz.step3Hint": "Agrega las horas que dedicó cada persona. Los salarios hacen el resto.",
    "batchwiz.step4Title": "Electricidad y alquiler",
    "batchwiz.step4Hint": "Opcional. Omítelo si no aplica a este lote.",
    "batchwiz.step5Title": "¿Qué embalaje se usó?",
    "batchwiz.step5Hint": "Cajas, bolsas, etiquetas — misma lógica por filas.",
    "batchwiz.step6Title": "¿Incluir desgaste de máquinas?",
    "batchwiz.step6Hint": "Opcional. Por tiempo o por producción.",
    "batchwiz.step7Title": "¿Cuánto beneficio quieres?",
    "batchwiz.step7Hint": "Elige un margen, un recargo o un beneficio fijo por unidad.",
    "batchwiz.step8Title": "Tu lote está costeado",
    "batchwiz.step8Hint": "Aquí está todo calculado automáticamente.",
    "batchwiz.miniLabel": "En vivo",
    "batchwiz.skipStep": "Omitir este paso",
    "batchwiz.openInQuickCost": "Abrir en Costeo Rápido",
    "batchwiz.print": "Imprimir / Guardar PDF",
    "batchwiz.startOver": "Empezar un nuevo lote",
    "batchwiz.save": "Guardar costeo",
    "batchwiz.snapshotName": "Nombre del costeo",
    "batchwiz.snapshotNamePlaceholder": "ej. Producción de junio",
    "batchwiz.confirmClear": "¿Empezar un nuevo lote? Se borrará tu progreso sin guardar.",
    "batchwiz.confirmClearYes": "Sí, empezar nuevo",
    "batchwiz.confirmClearNo": "Seguir trabajando",
    "batchwiz.electricity": "Electricidad",
    "batchwiz.rent": "Alquiler",
    "tpl.button": "Costeos guardados",
    "tpl.save": "Guardar costeo",
    "tpl.saveNew": "Guardar como nuevo",
    "tpl.update": "Actualizar este costeo",
    "tpl.duplicate": "Duplicar",
    "tpl.load": "Abrir costeo guardado",
    "tpl.loadEmpty": "Aún no hay costeos guardados. Guarda este costeo para volver a él más adelante.",
    "tpl.searchPlaceholder": "Buscar costeos guardados…",
    "tpl.nameLabel": "Nombre del costeo",
    "tpl.namePlaceholder": "ej. Camiseta de algodón — junio 2025",
    "tpl.modalSaveTitle": "Guardar este costeo",
    "tpl.modalSaveHint": "Guarda un registro permanente que puedes reabrir, ajustar precios o duplicar cuando cambien los costos.",
    "tpl.modalLoadTitle": "Costeos guardados",
    "tpl.modalLoadHint": "Selecciona un costeo para reabrirlo o crear una copia.",
    "tpl.chooseTitle": "¿Cómo quieres abrirlo?",
    "tpl.chooseEdit": "Abrir original",
    "tpl.chooseEditHint": "Sigue editando este costeo. Los cambios actualizan el registro guardado.",
    "tpl.choosePrefill": "Duplicar y editar",
    "tpl.choosePrefillHint": "Empieza un costeo nuevo a partir de este. El original queda intacto.",
    "tpl.cancel": "Cancelar",
    "tpl.confirm": "Confirmar",
    "tpl.delete": "Eliminar",
    "tpl.deleteConfirm": "¿Eliminar este costeo guardado?",
    "tpl.banner.editing": "Editando costeo guardado",
    "tpl.banner.prefilled": "Duplicado de un costeo guardado",
    "tpl.banner.exit": "Limpiar",
    "tpl.savedJustNow": "Guardado",
    "tpl.updated": "Actualizado",
    "tpl.duplicated": "Duplicado",
    "monthly.title": "Este mes",
    "monthly.subtitle": "Tres números — eso es todo lo que necesitamos.",
    "monthly.totalSales": "Ventas totales",
    "monthly.totalExpenses": "Gastos totales",
    "monthly.unitsProduced": "Unidades producidas",
    "monthly.netProfit": "Beneficio neto del mes",
  ...
  fr: {
    ...
    "sc.emptyHint": "Enregistrez un calcul depuis Coût Rapide ou Lot pour le voir ici.",
    "sc.openAt": "S'ouvre dans",
    "sc.unit": "unité",
    "header.tryDemo": "Essayer la démo",
    "quick.headerTitle": "Vos dépenses",
    "quick.headerSubtitle": "Indiquez simplement ce que vous avez utilisé et acheté. Nous faisons les calculs.",
    "quick.modeSimple": "Simple",
    "quick.modeAdvanced": "Avancé",
    "quick.modeSimpleHint": "Juste les matières, la main-d'œuvre et le prix.",
    "quick.modeAdvancedHint": "Détail complet — loyer, électricité, machines, mise à l'échelle.",
    "quick.productName": "Nom du produit",
    "quick.productNamePlaceholder": "ex. T-shirt en coton",
    "quick.unitsProduced": "Unités produites",
    "materials.title": "Quelles matières premières avez-vous utilisées ?",
    "materials.hint": "tissu, farine, huile — tout ce que vous avez utilisé",
    "materials.addLabel": "Ajouter une matière",
    "materials.empty": "Aucune matière ajoutée pour l'instant.",
    "materials.columnName": "Matière",
    "materials.columnQty": "Qté consommée",
    "materials.columnUnit": "Unité",
    "materials.columnPurchased": "Acheté",
    "materials.columnCost": "Coût",
    "materials.columnAuto": "Auto",
    "mat.sourceLocal": "Local",
    "mat.sourceImported": "Importé",
    "mat.delivery": "Livraison",
    "mat.materialPrice": "Prix de la matière",
    "mat.freight": "Fret",
    "mat.duty": "Droits de douane",
    "mat.taxes": "Taxes",
    "mat.taxAmount": "Montant de la taxe",
    "mat.taxRecoverable": "La taxe est récupérable",
    "mat.taxRecoverableYes": "Oui — exclue",
    "mat.taxRecoverableNo": "Non — incluse dans le coût",
    "mat.recoverableTaxNote": "Non inclus dans le coût du produit",
    "mat.taxInLandedCost": "Taxe incluse dans le coût du produit",
    "mat.taxColNonRecov": "Taxe (non récupérable)",
    "mat.taxColRecov": "Taxe (récupérable — exclue)",
    "mat.clearing": "Dédouanement / Autres",
    "mat.landedCost": "Coût de revient total",
    "mat.localHelper": "Le coût local comprend l'achat et la livraison.",
    "mat.importedHelper": "Le coût importé comprend le fret, les droits, les taxes et le dédouanement.",
    "mat.warningImportedBlank": "Importé sélectionné mais aucun coût d'importation saisi pour l'instant.",
    "mat.warningZeroLanded": "Le coût de revient est nul — saisissez d'abord le prix de la matière.",
    "labor.title": "Qui a travaillé sur cette production ?",
    "labor.hint": "heures utilisées vs. heures mensuelles totales",
    "labor.addLabel": "Ajouter une personne",
    "labor.empty": "Ajoutez la main-d'œuvre de cette production.",
    "labor.columnRole": "Poste",
    ...
    "electricity.hint": "part de la facture",
    "electricity.unitsUsed": "Unités utilisées",
    "electricity.billUnits": "Unités totales de la facture",
    "electricity.billAmount": "Montant de la facture",
    "electricity.warningUnitsExceed": "Les unités utilisées dépassent le total de la facture.",
    "rent.title": "Quelle part de loyer s'applique à la production ?",
    "rent.hint": "part de l'usine uniquement",
    "rent.tooltip": "Le loyer des bureaux et de l'administration ne devrait généralement pas affecter le coût de fabrication.",
    "rent.monthlyRent": "Loyer mensuel",
    "rent.factoryPct": "% Usine",
    "rent.warehousePct": "% Entrepôt",
    "rent.officePct": "% Bureau",
    "rent.daysUsed": "Jours utilisés",
    "rent.daysInMonth": "Jours du mois",
    "rent.includeWarehouse": "Inclure l'entrepôt",
    "rent.warningPct": "Les pourcentages ne totalisent pas 100%",
    "packaging.title": "Quel emballage a été utilisé ?",
    "packaging.hint": "cartons, sacs, étiquettes",
    "packaging.addLabel": "Ajouter un emballage",
    "packaging.empty": "Ajoutez l'emballage le cas échéant.",
    "other.title": "D'autres dépenses ?",
    "other.hint": "transport, réparations, autres",
    "other.addLabel": "Ajouter une dépense",
    "other.columnItem": "Article",
    "other.columnCost": "Coût",
    "machines.title": "Inclure l'usure des machines ?",
    "machines.hint": "facultatif",
    "machines.description": "Facultatif : inclure le coût d'usure des machines dans le calcul du produit.",
    "machines.on": "Activé",
    "machines.off": "Désactivé",
    "machines.methodTime": "Basé sur le temps",
    "machines.methodProduction": "Basé sur la production",
    "machines.columnMachine": "Machine",
    "machines.columnCost": "Coût",
    "machines.columnLife": "Durée de vie (ans)",
    "machines.columnDaysUsed": "Jours utilisés",
    "machines.columnDaysYear": "Jours / an",
    "machines.columnCapacity": "Capacité totale",
    "machines.columnBatch": "Unités du lot",
    "machines.columnAllocated": "Alloué",
    "machines.explainerTime": "Amortissement annuel = coût ÷ durée de vie. Puis calculé au prorata des jours utilisés.",
    "machines.explainerProduction": "Coût par unité = coût de la machine ÷ capacité totale. Multiplié par les unités produites.",
    "pricing.title": "Quel bénéfice souhaitez-vous ?",
    "pricing.modeMargin": "Marge %",
    "pricing.modeMarkup": "Majoration %",
    "pricing.modeTarget": "Bénéfice cible",
    "pricing.marginField": "Marge souhaitée (bénéfice en % du prix)",
    "pricing.markupField": "Majoration souhaitée (bénéfice en % du coût)",
    "pricing.targetField": "Bénéfice cible par unité",
    "pricing.marginHint": "Marge : bénéfice en part du prix de vente. 30% de marge = 30 de bénéfice sur une vente de 100.",
    "pricing.markupHint": "Majoration : bénéfice en part du coût. 40% de majoration sur un coût de 100 = prix de vente de 140.",
    "pricing.targetHint": "Fixez un bénéfice par unité. Prix = coût par unité + votre cible.",
    "whatif.title": "Et si vous produisiez plus ?",
    "whatif.hint": "voyez comment le coût par unité baisse avec l'échelle",
    "whatif.empty": "Saisissez d'abord vos coûts et unités pour simuler une production plus grande.",
    "whatif.intro": "Les coûts fixes (loyer, électricité, main-d'œuvre, machines) restent les mêmes. Les coûts variables (matières, emballage) évoluent avec la production.",
    "whatif.columnProduction": "Production",
    ...
    "whatif.if": "Si",
    "whatif.unitsLabel": "unités",
    "whatif.addScenario": "Ajouter un scénario",
    "whatif.whyTitle": "Pourquoi c'est important :",
    "whatif.whyBody": "Vos coûts fixes de {amount} sont répartis sur chaque unité que vous fabriquez. Produire plus d'unités signifie que chacune absorbe une part plus petite — c'est l'économie d'échelle.",
    ...
    "summary.groupCosts": "Coûts",
    "summary.groupDirect": "Coûts directs",
    "summary.groupIndirect": "Coûts indirects",
    "summary.groupOptional": "Facultatif",
    "summary.insights": "Analyses",
    "summary.savedSnapshots": "Instantanés enregistrés",
    "summary.sellAt": "Vendre à",
    "summary.enterData": "Saisir les données",
    ...
    "warning.usedExceedsPurchased": "La quantité utilisée dépasse la quantité achetée.",
    "warning.unitMismatch": "unités incompatibles",
    "warning.rowsHaveWarnings": "Certaines lignes comportent des avertissements",
    "insight.lossSelling": "Vous vendez en dessous du coût — chaque unité fait perdre de l'argent.",
    "insight.marginLow": "La marge est de {margin}% — en dessous de la plage recommandée pour la fabrication.",
    "insight.marginHealthy": "Une marge de {margin}% est solide — une bonne réserve pour les remises et les imprévus.",
    "insight.biggestLever": "Le coût de {name} représente {pct}% du total — votre plus grand levier.",
    "insight.largestCost": "{name} est le coût le plus élevé à {pct}%.",
    "insight.laborHigh": "Le coût de la main-d'œuvre est anormalement élevé — vérifiez les heures utilisées vs. la capacité mensuelle.",
    "insight.electricityMinimal": "L'impact de l'électricité est minime ici.",
    "insight.packagingHigh": "L'emballage réduit le bénéfice. Envisagez un achat en gros ou des alternatives.",
    "ui.quickAdd": "Ajout rapide",
    "ui.selectCurrency": "Choisir la devise",
    "ui.selectLanguage": "Langue",
    "ui.searchCurrency": "Rechercher une devise ou un code…",
    "ui.noCurrencyMatch": "Aucune devise ne correspond",
    "ui.enterUnitsHint": "Saisissez les unités produites pour calculer",
    "currency.warnTitle": "Devise non convertie",
    "currency.warnBody": "Changer de devise modifie uniquement le symbole — les montants existants ne sont PAS convertis. Vos chiffres seront traités dans la nouvelle devise.",
    "currency.warnSwitch": "Changer quand même",
    "currency.warnCancel": "Conserver l'actuelle",
    "row.incomplete": "Incomplet · non comptabilisé",
    "mat.purchaseCostTotal": "Coût d'achat total",
    "mat.consumed": "Consommé",
    "mat.purchaseCost": "Coût d'achat",
    "mat.autoCost": "Coût auto",
    "mobile.sellAt": "Vendre à",
    "report.brand": "Costix · Rapport de calcul de coût produit",
    "report.titleCosting": "Résumé du calcul de coût",
    ...
    "report.titleWhatIf": "Analyse de production à l'échelle",
    "report.metric": "Indicateur",
    "report.value": "Valeur",
    "report.category": "Catégorie",
    "report.group": "Groupe",
    "report.amount": "Montant",
    "report.shareOfTotal": "Part du total",
    "report.totalCost": "Coût total",
    "report.totalMaterials": "Total matières",
    "report.totalLabor": "Total main-d'œuvre",
    "report.totalMachineCost": "Coût total des machines",
    "report.note": "Remarque : Les coûts fixes de {amount} sont répartis sur chaque unité produite.",
    "report.scaleNote": "À mesure que le volume de production augmente, chaque unité absorbe une part plus petite du coût fixe.",
    "report.footer": "Généré par Costix",
    "landing.heroTitle": "Connaissez votre coût réel.",
    "landing.heroSubtitle": "Plus intelligent que les tableurs. Plus simple qu'un ERP. Dites-nous ce que vous avez acheté et utilisé — Costix s'occupe du reste.",
    "landing.cta": "Commencer à calculer",
    "landing.badge": "Le calcul de coûts moderne pour la fabrication moderne",
    "landing.heroTitleA": "Connaissez votre coût réel.",
    ...
    "batch.stepLabel": "Étape",
    "batch.stepOf": "sur",
    "batch.resultLabel": "Résultat",
    "batch.back": "Retour",
    ...
    "batch.q2Hint": "Coût total des matières premières de ce lot.",
    ...
    "batch.q3LabelRate": "Tarif / heure",
    "batch.q4Title": "Des dépenses supplémentaires ?",
    ...
    "batchwiz.step1Title": "Parlez-nous de cette production",
    "batchwiz.step1Hint": "Juste l'essentiel — le nom et la quantité produite.",
    "batchwiz.step2Title": "Quelles matières premières avez-vous utilisées ?",
    "batchwiz.step2Hint": "Ajoutez ce que vous avez consommé. Nous calculons le coût.",
    "batchwiz.step3Title": "Qui a travaillé sur cette production ?",
    "batchwiz.step3Hint": "Ajoutez les heures passées par chaque personne. Les salaires font le reste.",
    "batchwiz.step4Title": "Électricité et loyer",
    "batchwiz.step4Hint": "Facultatif. Ignorez si non pertinent pour ce lot.",
    "batchwiz.step5Title": "Quel emballage a été utilisé ?",
    "batchwiz.step5Hint": "Cartons, sacs, étiquettes — même logique par lignes.",
    "batchwiz.step6Title": "Inclure l'usure des machines ?",
    "batchwiz.step6Hint": "Facultatif. Basé sur le temps ou la production.",
    "batchwiz.step7Title": "Quel bénéfice souhaitez-vous ?",
    "batchwiz.step7Hint": "Choisissez une marge, une majoration ou un bénéfice fixe par unité.",
    "batchwiz.step8Title": "Votre lot est calculé",
    "batchwiz.step8Hint": "Voici tout calculé automatiquement.",
    "batchwiz.miniLabel": "En direct",
    "batchwiz.skipStep": "Ignorer cette étape",
    "batchwiz.openInQuickCost": "Ouvrir dans Coût Rapide",
    "batchwiz.print": "Imprimer / Enregistrer en PDF",
    "batchwiz.startOver": "Commencer un nouveau lot",
    "batchwiz.save": "Enregistrer le calcul",
    "batchwiz.snapshotName": "Nom du calcul",
    "batchwiz.snapshotNamePlaceholder": "ex. Production de juin",
    "batchwiz.confirmClear": "Commencer un nouveau lot ? Votre progression non enregistrée sera effacée.",
    "batchwiz.confirmClearYes": "Oui, recommencer",
    "batchwiz.confirmClearNo": "Continuer",
    "batchwiz.electricity": "Électricité",
    "batchwiz.rent": "Loyer",
    "tpl.button": "Calculs enregistrés",
    "tpl.save": "Enregistrer le calcul",
    "tpl.saveNew": "Enregistrer comme nouveau",
    "tpl.update": "Mettre à jour ce calcul",
    "tpl.duplicate": "Dupliquer",
    "tpl.load": "Ouvrir un calcul enregistré",
    "tpl.loadEmpty": "Aucun calcul enregistré pour l'instant. Enregistrez ce calcul pour y revenir plus tard.",
    "tpl.searchPlaceholder": "Rechercher des calculs enregistrés…",
    "tpl.nameLabel": "Nom du calcul",
    "tpl.namePlaceholder": "ex. T-shirt en coton — juin 2025",
    "tpl.modalSaveTitle": "Enregistrer ce calcul",
    "tpl.modalSaveHint": "Enregistre un dossier permanent que vous pouvez rouvrir, ajuster ou dupliquer quand les coûts changent.",
    "tpl.modalLoadTitle": "Calculs enregistrés",
    "tpl.modalLoadHint": "Sélectionnez un calcul pour le rouvrir ou en créer une copie.",
    "tpl.chooseTitle": "Comment souhaitez-vous l'ouvrir ?",
    "tpl.chooseEdit": "Ouvrir l'original",
    "tpl.chooseEditHint": "Continuez à modifier ce calcul. Les changements mettent à jour le dossier enregistré.",
    "tpl.choosePrefill": "Dupliquer et modifier",
    "tpl.choosePrefillHint": "Démarrez un nouveau calcul à partir de celui-ci. L'original reste intact.",
    "tpl.cancel": "Annuler",
    "tpl.confirm": "Confirmer",
    "tpl.delete": "Supprimer",
    "tpl.deleteConfirm": "Supprimer ce calcul enregistré ?",
    "tpl.banner.editing": "Modification d'un calcul enregistré",
    "tpl.banner.prefilled": "Dupliqué d'un calcul enregistré",
    "tpl.banner.exit": "Effacer",
    "tpl.savedJustNow": "Enregistré",
    "tpl.updated": "Mis à jour",
    "tpl.duplicated": "Dupliqué",
    "monthly.title": "Ce mois-ci",
    "monthly.subtitle": "Trois chiffres — c'est tout ce qu'il nous faut.",
