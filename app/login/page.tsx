...
const CostixMark = ({ size = 36 }: { size?: number }) => {
  ...
  return (
    ...
    >
      ...
      <rect width="36" height="36" rx={rx} fill="url(#cxG-login)" />
      {bars.map(({ y, w, op, d }, i) => (
        <motion.rect
      ...
      <div className="relative w-full max-w-sm">
        ...
        >
          ...
          <div className="space-y-4">
            <Field label="Email"    type="email"    placeholder="you@company.com" delay={0.28} />
            <Field label="Password" type="password" placeholder="••••••••"        delay={0.34} />
        ...
        >
          <p className="text-sm text-slate-500">
            No account?{' '}
            <Link href="/signup" className="font-medium text-teal-700 hover:underline underline-offset-2">
              Sign up free
            </Link>
          </p>
